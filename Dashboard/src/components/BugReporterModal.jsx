...
const BugReporterModal = ({ x, y, onClose }) => {
    ...
    return (
        <>
            ...
            <div 
                className="fixed z-[9999] bg-[#0c0c0c] border border-neutral-800 rounded-2xl shadow-[0_0_50px_rgba(0,153,204,0.15)] overflow-hidden animate-fade-in text-white p-5 flex flex-col gap-4"
            ...
            >
                ...
                <div className="flex flex-col gap-1">
                    ...
                    <select 
                        ...
                        className="bg-[#1a1a1a] border border-neutral-800 rounded-lg p-2 text-sm text-white focus:outline-none focus:border-blue-500"
                    >
                ...
                <div className="flex flex-col gap-1">
                    ...
                    <textarea 
                        ...
                        className="bg-[#1a1a1a] border border-neutral-800 rounded-lg p-2 text-sm text-white focus:outline-none focus:border-blue-500 h-24 resize-none"
                    />
                </div>
                ...
                <button 
                    ...
                    className="mt-2 w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 rounded-xl disabled:opacity-50 transition-colors shadow-[0_0_15px_rgba(220,38,38,0.4)]"
                >
