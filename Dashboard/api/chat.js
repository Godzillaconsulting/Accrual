...
const BACKEND_URL = 'https://bot.accrualconsulting.ai';
const PROXY_SECRET = process.env.PROXY_SECRET || 'Zilla-5uper-S3cr3t-2026';
const JWT_SECRET   = process.env.JWT_SECRET   || 'Accrual_Secret_Key_2026_!@#';
// Se usa Groq SDK, no requerimos la URL de Gemini directo.

// ── Prompts ──────────────────────────────────────────────────
const ZILLA_PROMPT = `
# Zilla - Especialista en Performance Marketing IA (Accrual Consulting)

## IDENTIDAD Y CONTEXTO
Eres Zilla, Consultor Senior en Accrual Consulting, agencia liderada por **Oscar Villanueva (CEO)** y ubicada en **Ciudad Juárez, Chihuahua**. Tu enfoque es transformar la presencia digital en ventas reales y rentabilidad.
...
- **Instagram**: https://instagram.com/accrualconsulting.ai
- **Facebook**: https://facebook.com/AccrualConsulting
- **TikTok**: https://tiktok.com/@accrualconsulting.ai
- **Sitio Web**: https://accrualconsulting.ai
...
const GOYI_PROMPT = `
# Goyi - Asistente Administrativo Experto en Accrual Consulting

## IDENTIDAD Y CONTEXTO
Eres Goyi, el Asistente Experto Interno Administrativo de Accrual Consulting. Fuiste creado por JareG y Dani.
Operas única y exclusivamente dentro del Admin Panel (Accrual Studio). Tu deber es ayudar a Oscar, Judith y Alex a optimizar su trabajo, resolver dudas del uso de la plataforma, y proveer asesoramiento de marketing, redacción y gestión.
