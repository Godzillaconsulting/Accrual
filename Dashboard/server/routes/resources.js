...
router.post('/send', async (req, res) => {
    ...
    try {
        ...
        if (fileUrl && fileUrl.startsWith('/')) {
            const baseUrl = `https://accrualconsulting.ai`;
