...
// ──────────────────────────────────────────────────────────
// 2. Solo Super Admins (JareG / Oscar / accrual_admin)
// ──────────────────────────────────────────────────────────
export const requireSuperAdmin = (req, res, next) => {
    ...
    const isSuperAdmin = user.role === 'admin' || 
        ['jareg', 'oscar', 'accrual_admin'].includes(user.username?.toLowerCase());
...
export const requireCM = (req, res, next) => {
    ...
    const allowed = user.role === 'admin' || user.role === 'cm' ||
        ['jareg', 'oscar', 'accrual_admin', 'judith'].includes(user.username?.toLowerCase());
...
export const requireCMOrCockers = (req, res, next) => {
    ...
    const allowed = user.role === 'admin' || user.role === 'cm' || user.role === 'cockers' ||
        ['jareg', 'oscar', 'accrual_admin', 'judith', 'alex', 'cockers'].includes(user.username?.toLowerCase());
