                ...
                try {
                    ...
                    if (modelName.startsWith('imagen')) {
                        ...
                        if (response.generatedImages?.[0]?.image?.imageBytes) {
                            ...
                            const savePath = path.join('E:/AccrualSora_Outputs', fileName);
                    ...
                    console.log(`[GOOGLE-VISION] 🔄 Fallback a ACCRUAL NATIVE TENSOR (Local GPU)...`);
                    try {
...
export const refineRenderJob = async (req, res) => {
    try {
        ...
        if (imageUrl.startsWith('http')) {
            ...
            const localPath = path.join('E:/AccrualSora_Outputs', fileName);
