...
const BASE = 'https://accrualconsulting.ai';
const tests = [
  ...
  { name: 'Login API',           url: `${BASE}/api/auth/login`,         method: 'POST', body: { username: 'accrual_admin', password: 'Accrual2026!' } },
  { name: 'Login accrual_admin',url: `${BASE}/api/auth/login`,         method: 'POST', body: { username: 'accrual_admin', password: 'Accrual2026!' } },
  { name: 'Login cockers',       url: `${BASE}/api/auth/login`,         method: 'POST', body: { username: 'cockers',        password: 'pussyniggabitch' } },
];

console.log('\n🦖 ACCRUAL CONSULTING — HEALTH CHECK PRE-LIVE\n' + '═'.repeat(50));
...
console.log('\n' + '═'.repeat(50));
console.log('🚀 Sitio: https://accrualconsulting.ai');
console.log('🔐 Admin: https://accrualconsulting.ai/login');
