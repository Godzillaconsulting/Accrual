    ...
    try {
        ...
        await client.query(`
            ...
            VALUES (
                ...
                'https://accrualconsulting.ai/recurso.pdf'
        ...
        await client.query(`
            GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA public TO accrual_backend;
            GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA public TO accrual_backend;
        `);
        console.log('✅ Permisos otorgados a accrual_backend.');
    } catch (err) {
