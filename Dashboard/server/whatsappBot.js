...
export const initWhatsAppBot = async () => {
    ...
    // Ruta persistente segura fuera del despliegue: ~/.accrual-sessions

    const sessionPath = path.join(os.homedir(), '.accrual-sessions', 'whatsapp');
    ...
    try {
        ...
        for (const line of lines) {
            ...
            if (line.includes('accrual-sessions') && line.includes('whatsapp')) {
        ...
        try {
            ...
            res.send(`
                <div style="display: flex; flex-direction: column; align-items: center; justify-content: center; height: 100vh; font-family: sans-serif; background: #111; color: white;">
                    ...
                    <p style="margin-top: 20px; opacity: 0.6;">Accrual Consulting - Bot Authentication</p>
                </div>
            `);
        } catch (e) {
