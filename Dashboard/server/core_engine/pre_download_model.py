...
os.environ["HF_HOME"] = "E:\\AccrualSora_Models"
os.environ["TORCH_HOME"] = "E:\\AccrualSora_Models\\torch"
import torch
from diffusers import DiffusionPipeline

print("==================================================")
print("[ACCRUAL SORA] Iniciando Descarga del Núcleo Crítico Oculto...")
...
try:
    ...
    print("\n[ACCRUAL SORA] DESCARGA FOTORREALISTA ORO FINALIZADA CON ÉXITO.")
