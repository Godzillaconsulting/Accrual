export const data2 = [
    {
        ...
        content: `
            ...
            <p>Los delitos fiscales pueden ser clasificados como delitos penales en muchos países, y las implicaciones legales más graves incluyen penas de prisión. En México, por ejemplo, el Código Penal Federal y el Código Fiscal de la Federación establecen que los delitos fiscales pueden ser sancionados con prisión, dependiendo de la naturaleza y el monto de la infracción.</p>
            <ul>
                <li><strong>Prisión:</strong> En el caso de evasión fiscal, si se demuestra que se ocultaron ingresos o se proporcionaron declaraciones falsas, las autoridades pueden imponer penas de prisión, que varían según el monto defraudado.</li>
            ...
            <ul>
                <li><strong>Multas:</strong> Las autoridades fiscales pueden imponer multas económicas para sancionar la evasión de impuestos, la incorrecta declaración de ingresos o la omisión de pagos.</li>
    ...
    },
    {
        ...
        content: `
            ...
            <ol>
                <li><strong>Imposibilidad de Emitir Facturas Electrónicas:</strong> La suspensión de los sellos digitales impide al contribuyente emitir facturas electrónicas a través del Sistema de Administración Tributaria (SAT) y de todos los proveedores de facturación autorizados.</li>
                <li><strong>Pérdida de Credibilidad Empresarial:</strong> La suspensión de los sellos digitales genera una mala imagen pública y puede ser percibida como una señal de irregularidad fiscal por parte de los clientes y proveedores.</li>
            </ol>
        `
    },
    {
