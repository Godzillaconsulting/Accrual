    ...
    return (
        ...
        >
            ...
            <div className={`absolute right-0 top-0 bottom-0 w-80 bg-neutral-950 border-l border-neutral-800 shadow-2xl z-30 transform transition-transform duration-300 flex flex-col ${selectedNodeId ? 'translate-x-0' : 'translate-x-full'}`}>
                {selectedNode && (
                    <>
                        <div className="p-5 border-b border-neutral-800 flex justify-between items-center bg-[#152033]">
                            ...
                            <div className="space-y-4">
                                <div className="space-y-1">
                                    ...
                                    <input 
                                        ...
                                        className="w-full bg-[#152033] border border-neutral-800 rounded-lg px-3 py-2 text-white text-sm outline-none focus:border-white transition-colors"
                                    />
                                </div>
                                <div className="space-y-1">
                                        ...
                                        if (pData) {
                                            return (
                                                <>
                                                    ...
                                                    <button onClick={() => handleRestartProcess(selectedNode.pm2_process)} className="w-full mt-2 py-2 bg-[#152033] border border-neutral-700 hover:border-neutral-500 text-xs font-bold text-white rounded-lg transition-colors">Reiniciar Proceso</button>
                                                </>
                                            );
                                        } else {
                        ...
                        <div className="p-5 border-t border-neutral-800 bg-[#152033]">
                            <button 
