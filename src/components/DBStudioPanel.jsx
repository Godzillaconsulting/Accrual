    ...
    return (
        <div className="flex w-full h-full bg-[#0a0a0a] text-neutral-300 font-mono text-sm border-l border-blue-900/30 overflow-hidden">
                ...
                <div className="p-3">
                    {isJareg && (
                        <button 
                            ...
                            className={`w-full py-2.5 rounded hover:bg-[#0099CC]/20 hover:text-white transition-all text-xs font-bold border border-transparent flex items-center justify-center gap-2 ${queryMode ? 'bg-[#0099CC]/20 text-[#0099CC] border-[#0099CC]/50' : 'bg-neutral-900 text-neutral-400'}`}
                        >
                    ...
                    <div className="space-y-0.5">
                        {tables.map(t => (
                            <button 
                                key={t} 
                                onClick={() => loadTable(t)}
                                className={`w-full text-left px-3 py-1.5 rounded transition-all text-sm flex items-center gap-2 truncate ${selectedTable === t && !queryMode ? 'bg-[#0099CC]/10 text-white font-bold border-l-2 border-[#0099CC]' : 'text-neutral-400 hover:bg-neutral-900 hover:text-neutral-200'}`}
                            >
            ...
            <div className="flex-1 flex flex-col min-w-0" style={{ background: 'radial-gradient(ellipse at top right, rgba(0,153,204,0.05), transparent 40%)' }}>
                ...
                {queryMode && isJareg && (
                    <div className="flex flex-col border-b border-blue-900/30 p-4 bg-neutral-900/50 backdrop-blur shrink-0 z-10 transition-all shadow-md">
                        ...
                        <div className="relative">
                            <textarea
                                ...
                                spellCheck={false}
                                className="w-full h-32 bg-[#233657] text-[#0099CC] p-4 rounded-xl border border-blue-900/50 focus:border-[#0099CC] focus:ring-1 focus:ring-[#0099CC] focus:outline-none resize-none font-mono text-sm leading-relaxed"
                            ...
                            <div className="absolute bottom-3 right-3 flex items-center gap-3">
                                ...
                                <button 
                                    ...
                                    disabled={loading}
                                    className="px-5 py-2 bg-[#0099CC] hover:bg-blue-600 text-white text-xs font-bold rounded-lg shadow-[0_2px_10px_rgba(0,153,204,0.5)] transition"
                                >
