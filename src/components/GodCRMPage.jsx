...
export default function GodCRMPage() {
  ...
  /* ── Render ────────────────────────────────────────────────────────── */
  return (
    <div className="min-h-screen w-full" style={{ background: 'linear-gradient(160deg, #0a0f1a 0%, #111 40%, #152033 100%)' }}>
      {/* ── Header ───────────────────────────────────────────────────── */}
      ...
      {/* ── Kanban Board ─────────────────────────────────────────────── */}
      <main className="mx-auto max-w-[1800px] overflow-x-auto px-6 py-6">
        <div className="flex gap-4" style={{ minWidth: COLUMNS.length * 300 }}>
          {COLUMNS.map((col) => {
            ...
            return (
              <div
                key={col.key}
                className="flex w-72 shrink-0 flex-col rounded-2xl border transition-colors duration-200"
                style={{
              ...
              >
                ...
                {/* Cards */}
                <div className="flex flex-1 flex-col gap-3 p-3" style={{ minHeight: 120 }}>
