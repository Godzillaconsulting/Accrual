...
export default function IntegratedVideoEditor({ initialVideoUrl, queue = [], onClose }) {
    ...
    const handleRender = async () => {
        ...
        try {
            ...
            a.href = url;
            a.download = `accrual_pro_edit_${Date.now()}.mp4`;
            a.click();
    ...
    return (
        <div className="flex-1 w-full flex flex-col bg-[#080808] border-t border-blue-900/30 overflow-hidden relative">
                {/* Cabecera del Editor */}
                <div className="w-full h-16 bg-neutral-900 border-b border-neutral-800 flex items-center justify-between px-6 shrink-0">
                    <div className="flex items-center gap-3">
                        ...
                        <h2 className="text-white font-bold text-lg tracking-tight">Accrual Pro Editor</h2>
                    </div>
                ...
                <div className="flex flex-col flex-1 min-h-0">
                    ...
                    <div className="flex-1 flex gap-4 p-4 min-h-0 bg-neutral-950">
                                ...
                                <div className="space-y-2">
                                    {displayVideos.length === 0 ? (
                                        ...
                                        displayVideos.map(vid => (
                                            ...
                                            >
                                                <video src={vid.media_options[0].url} className="w-16 h-12 object-cover rounded bg-[#152033] shrink-0" />
                        ...
                        {/* Reproductor Central */}
                        <div className="flex-1 bg-[#152033] rounded-xl border border-neutral-800 flex flex-col items-center justify-center relative overflow-hidden">
                            {initialVideoUrl ? (
                                <video 
                                    ref={videoRef}
                                    src={initialVideoUrl} 
                    ...
                    <div className="h-64 bg-neutral-900 border-t border-neutral-800 shrink-0 select-none flex flex-col">
                        ...
                        <div className="h-10 bg-neutral-950 flex items-center justify-between px-4 border-b border-neutral-800 shrink-0">
                            <div className="flex items-center gap-2">
                                ...
                                <button onClick={handleDeleteClip} className="flex items-center gap-1.5 px-3 py-1 bg-neutral-800 hover:bg-blue-900/40 text-neutral-300 hover:text-blue-400 text-[10px] font-bold uppercase rounded border border-neutral-700 transition-colors">
