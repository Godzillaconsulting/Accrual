    ...
    return (
        <section className="bg-[#D0D0DA] text-[#233657] py-24 px-4 overflow-hidden relative">
            <div className="max-w-7xl mx-auto flex flex-col items-center text-center relative z-10">
                ...
                <button className="bg-[#0F4C82] hover:bg-[#233657] text-[#D0D0DA] font-bold py-3 px-8 rounded-full text-lg flex items-center gap-2 transition-all shadow-lg transform hover:scale-105 mb-16">
