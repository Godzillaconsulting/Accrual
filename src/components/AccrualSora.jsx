...
export default function AccrualSora() {
    ...
    const [logs, setLogs] = useState(["[SYSTEM] Accrual In-House Cluster Iniciado.", "[SYSTEM] GPU A100 Detectadas: 4", "[SYSTEM] Esperando Prompts..."]);
                ...
                <section className="sora-canvas">
                    ...
                    <div className="prompt-container panel-glass">
                        ...
                        <textarea 
                            ...
                            placeholder="Ej. Cinematic shot of Accrual drinking coffee in neon Tokyo..."
                            value={prompt}
