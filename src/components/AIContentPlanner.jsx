        ...
        <div className="w-full h-full bg-[#0a0a0a] flex flex-col relative overflow-hidden font-sans">
            ...
            <div className="px-6 py-4 border-b border-neutral-800 bg-neutral-950 flex justify-between items-center shrink-0">
                ...
                <div className="flex items-center gap-3">
                    {!canEdit && (
                        <span className="text-[10px] bg-blue-900/30 text-blue-400 border border-blue-500/30 px-3 py-1.5 rounded-full font-bold">
                            🔒 Solo Lectura
                        </span>
                    )}
                    {plan && (
                        <div className="flex items-center gap-2">
                            {canEdit && (
                                <div className="flex items-center bg-[#152033]/50 border border-neutral-800 rounded-xl overflow-hidden shadow-inner">
                                    <input 
                                        type="url" 
                ...
                <div className="flex flex-wrap gap-3 items-end">
                    <div className="flex-1 min-w-[200px]">
                        ...
                        <input
                            ...
                            className="w-full bg-[#152033]/50 border border-neutral-800 rounded-xl px-4 py-2.5 text-white text-sm focus:outline-none focus:border-purple-500 transition-colors disabled:opacity-50"
                        />
                    </div>
                    <div className="w-36">
                        ...
                        <select
                            ...
                            disabled={!canEdit || isGenerating}
                            className="w-full bg-[#152033]/50 border border-neutral-800 rounded-xl px-3 py-2.5 text-white text-sm focus:outline-none focus:border-purple-500 disabled:opacity-50"
                        >
            ...
            <div className="flex-1 overflow-y-auto px-6 py-6">
                {isGenerating ? (
                    ...
                    <div className="h-full flex flex-col items-center justify-center text-neutral-600">
                        ...
                        {!canEdit && (
                            <p className="text-xs mt-2 text-blue-500/60 font-bold">Solo Alex u Oscar pueden generar planes.</p>
                        )}
                    </div>
                ) : (
