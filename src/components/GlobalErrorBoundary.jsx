...
class GlobalErrorBoundary extends React.Component {
  ...
  render() {
    if (this.state.hasError) {
      return (
        <div className="min-h-screen w-full flex flex-col items-center justify-center bg-[#233657] text-white p-6 z-50 fixed top-0 left-0">
          <main className="max-w-xl w-full bg-[#111111] p-8 rounded-[2rem] border-2 border-[#0099CC] shadow-[0_0_30px_rgba(0,153,204,0.3)]">
            <h1 className="text-3xl font-black text-[#0099CC] mb-4">ERROR DEL SISTEMA</h1>
