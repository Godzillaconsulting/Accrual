...
const About = () => {
    return (
        <section className="bg-[#e0e0e0] py-20 px-4">
            <div className="max-w-6xl mx-auto">
                <h2 className="text-4xl md:text-5xl font-black text-center text-black mb-16 uppercase">
                    ¿Quiénes <br /> Somos?
                </h2>
                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="space-y-6 text-black">
                        <h3 className="text-3xl font-bold mb-4 uppercase">Nuestra Historia</h3>
                        ...
                        <button className="mt-8 bg-[#2d3830]/20 hover:bg-[#2d3830] text-[#2d3830] hover:text-[#e0e0e0] font-bold py-3 px-8 rounded-full uppercase text-sm transition-all transform hover:scale-105 shadow-md backdrop-blur-xl border border-[#2d3830]/20">
                            Conoce nuestros servicios
                        </button>
                    </div>

                    {/* Image Placeholder */}
                    <div className="bg-[#3D3D3D] rounded-3xl aspect-[4/3] flex items-center justify-center overflow-hidden">
