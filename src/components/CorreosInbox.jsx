            ...
            <div className="w-[35%] bg-[#0a0a0a] border-r border-neutral-800 flex flex-col">
                <div className="p-4 border-b border-neutral-800 bg-neutral-900/50">
                    <h3 className="text-sm font-black text-white flex items-center gap-2">
                        <Mail size={16} className="text-[#0099CC]"/> Bandeja de Salida
                    </h3>
                    ...
                    {recursos.map(idx => (
                        <button 
                            ...
                            className={`w-full text-left p-4 border-b border-neutral-800 transition-all ${
                                selectedIdx === idx 
                                ? 'bg-[#0099CC]/10 border-l-2 border-l-[#0099CC]' 
                                : 'hover:bg-neutral-900 border-l-2 border-l-transparent'
                            }`}
                        >
                            <div className="flex justify-between items-start mb-1">
                                <span className={`text-[10px] font-bold ${selectedIdx === idx ? 'text-[#0099CC]' : 'text-neutral-500'}`}>
                                    Recurso {idx}
                                </span>
                ...
                <div className="px-6 py-4 border-b border-gray-200 bg-gray-50 flex items-center justify-between">
                    <div>
                        ...
                        <div className="text-[11px] text-gray-500 flex items-center gap-2 mt-1">
                            <span className="flex items-center gap-1"><User size={12}/> De: Accrual (Automático)</span>
                            <span>•</span>
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <input 
                                ...
                                className="w-full p-3 bg-white border border-gray-300 rounded-lg text-gray-900 text-sm focus:border-[#0099CC] focus:ring-1 focus:ring-[#0099CC] outline-none shadow-sm transition"
                        ...
                        <div>
                            ...
                            <textarea 
                                ...
                                className="w-full p-4 bg-white border border-gray-300 rounded-lg text-gray-800 text-sm focus:border-[#0099CC] focus:ring-1 focus:ring-[#0099CC] outline-none resize-none shadow-sm leading-relaxed"
                                placeholder="Hola,\nGracias por..."
                            />
                        </div>
                        ...
                        <div className="bg-gray-50 border border-gray-200 p-4 rounded-lg flex flex-col items-center justify-center space-y-3">
                            ...
                            <div className="relative group w-full max-w-sm">
                                <span className="absolute -top-2 -left-2 bg-[#152033] text-white text-[9px] px-2 py-0.5 rounded shadow z-10 font-bold">Botón Rojo del PDF</span>
                                <input 
                                    type="text"
                                    value={activeData.url}
                                    onChange={e => change(`recurso${selectedIdx}FileUrl`, e.target.value)}
                                    className="w-full pl-9 pr-3 py-3 bg-white border-2 border-gray-300 rounded-xl text-gray-900 text-xs focus:border-[#0099CC] outline-none shadow-sm text-center font-mono"
                                    placeholder="https://"
                                />
