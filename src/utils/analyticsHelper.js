 ...
 * tanto a Meta Pixel como al servidor de Accrual Analytics.
 */

export const trackAccrualEvent = async (eventName, eventData = {}) => {
  try {
    ...
    console.error('Error in trackAccrualEvent:', error);
  }
};
