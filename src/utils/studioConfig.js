...
export const PAGE_SECTIONS = [
 { id:'hero', label:'Encabezado principal', icon:'Home', tag:'SITIO PRINCIPAL' },
 { id:'auditoria-cta', label:'Auditoría Rayos X (CTA)', icon:'Target', tag:'SITIO PRINCIPAL' },
 { id:'paquetes', label:'Paquetes', icon:'Package', tag:'SITIO PRINCIPAL' },
 { id:'testimonios', label:'Testimonios', icon:'MessageSquare', tag:'SITIO PRINCIPAL' },

 { id:'quienes-somos', label:'Quiénes somos', icon:'Building2', tag:'QUIÉNES SOMOS' },

 { id:'servicios-grid', label:'Servicios Grid', icon:'Zap', tag:'SERVICIOS' },
 { id:'servicio-consultoria', label:'Consultoría', icon:'BarChart3', tag:'SERVICIOS' },
 { id:'servicio-planificacion-avanzada', label:'Planificación fiscal avanzada', icon:'Calendar', tag:'SERVICIOS' },
 { id:'servicio-declaracion', label:'Declaración de impuestos', icon:'FileText', tag:'SERVICIOS' },
 { id:'servicio-imss', label:'IMSS e Infonavit', icon:'Activity', tag:'SERVICIOS' },
 { id:'servicio-repse', label:'REPSE', icon:'FileCheck', tag:'SERVICIOS' },
 { id:'servicio-nomina', label:'Administración de nómina', icon:'Users', tag:'SERVICIOS' },
 { id:'servicio-contabilidad', label:'Contabilidad', icon:'Laptop', tag:'SERVICIOS' },
 { id:'servicio-asesoria-planificacion', label:'Asesoría en planif. fiscal', icon:'TrendingUp', tag:'SERVICIOS' },
 { id:'servicio-cumplimiento-tributario', label:'Cumplimiento tributario', icon:'Scale', tag:'SERVICIOS' },
 { id:'servicio-cumplimiento-seguridad', label:'Cumplimiento en seg. social', icon:'ShieldCheck', tag:'SERVICIOS' },
 { id:'servicio-consultoria-financiera', label:'Consultoría financiera', icon:'Lightbulb', tag:'SERVICIOS' },
 { id:'servicio-auditoria', label:'Auditoría financiera', icon:'Search', tag:'SERVICIOS' },
 { id:'servicio-asesoria-contable', label:'Asesoría contable', icon:'BookOpen', tag:'SERVICIOS' },
 { id:'servicio-facturacion', label:'Facturación', icon:'Receipt', tag:'SERVICIOS' },
 { id:'servicio-capacitacion', label:'Capacitación', icon:'GraduationCap', tag:'SERVICIOS' },
 { id:'servicio-ley-federal', label:'Ley federal prev. ilícita', icon:'AlertTriangle', tag:'SERVICIOS' },

 { id:'articulos-grid', label:'Artículos Grid', icon:'BookOpen', tag:'ARTÍCULOS' },
 { id:'articulo-1', label:'Errores en declaración', icon:'File', tag:'ARTÍCULOS' },
 { id:'articulo-2', label:'Beneficios de un asesor fiscal', icon:'File', tag:'ARTÍCULOS' },
 { id:'articulo-3', label:'Beneficios del compliance', icon:'File', tag:'ARTÍCULOS' },
 { id:'articulo-4', label:'Importancia del presupuesto', icon:'File', tag:'ARTÍCULOS' },
 { id:'articulo-5', label:'Implicaciones de delitos fisc.', icon:'File', tag:'ARTÍCULOS' },
 { id:'articulo-6', label:'Suspensión de sellos', icon:'File', tag:'ARTÍCULOS' },
 { id:'articulo-7', label:'Partes relacionadas y precios', icon:'File', tag:'ARTÍCULOS' },
 { id:'articulo-8', label:'Acciones BEPS', icon:'File', tag:'ARTÍCULOS' },
];
