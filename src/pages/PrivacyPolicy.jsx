        ...
        <div className="font-sans antialiased text-gray-800 bg-gray-50 flex flex-col min-h-screen">
            ...
            <main className="flex-grow pt-24 pb-16 px-6 lg:px-8">
                <div className="max-w-4xl mx-auto bg-white p-8 md:p-12 rounded-2xl shadow-sm border border-gray-100">
                    <h1 className="text-3xl md:text-4xl font-bold text-[#47544b] mb-8 text-center uppercase tracking-wide">Privacidad</h1>
                    <div className="text-center font-bold text-lg mb-8 uppercase tracking-wider text-[#47544b]/80">Aviso de privacidad integral</div>

                    <div className="space-y-8 text-sm md:text-base leading-relaxed text-gray-600">

                        <p className="mb-4 text-justify">
                            Accrual Accounting Services S.C. mejor conocido como ACCRUAL, con domicilio en Minerva 1174, Olimpia, Juarez, chihuahua, Mexico y portal de internet accrual.com.mx, es el responsable del uso y protección de sus datos personales, y al respecto le informamos lo siguiente:
                        </p>

                        <section>
                            <h2 className="text-xl font-bold text-[#47544b] mb-4 uppercase tracking-wider">¿Para qué fines utilizaremos sus datos personales?</h2>
                            <p className="mb-4">
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-[#47544b] mb-4 uppercase tracking-wider">¿Qué datos personales utilizaremos para estos fines?</h2>
                            <p className="mb-4">
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-[#47544b] mb-4 uppercase tracking-wider">¿Cómo puede acceder, rectificar o cancelar sus datos personales, u oponerse a su uso o ejercer la revocación de consentimiento?</h2>
                            <p className="mb-4 text-justify">
                                Usted tiene derecho a conocer qué datos personales tenemos de usted, para qué los utilizamos y las condiciones del uso que les damos (Acceso). Asimismo, es su derecho solicitar la corrección de su información personal en caso de que esté desactualizada, sea inexacta o incompleta (Rectificación); que la eliminemos de nuestros registros o bases de datos cuando considere que la misma no está siendo utilizada adecuadamente (Cancelación); así como oponerse al uso de sus datos personales para fines específicos (Oposición). Estos derechos se conocen como derechos ARCO.
                            </p>
                            <p className="mb-4">
                                Para el ejercicio de cualquiera de los derechos ARCO, debe enviar una petición vía correo electrónico a <a href="mailto:contacto@accrual.com.mx" className="text-[#47544b] font-bold hover:underline">contacto@accrual.com.mx</a> y deberá contener:
                            </p>
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-[#47544b] mb-4 uppercase tracking-wider">El uso de tecnologías de rastreo en nuestro portal de internet</h2>
                            <p className="mb-4 text-justify">
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-[#47544b] mb-4 uppercase tracking-wider">¿Cómo puede conocer los cambios en este aviso de privacidad?</h2>
                            <p className="mb-4 text-justify">
                        ...
                        <div className="pt-8 text-xs text-gray-500 italic text-right border-t border-gray-200">
