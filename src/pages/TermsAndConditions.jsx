        ...
        <div className="font-sans antialiased text-gray-800 bg-gray-50 flex flex-col min-h-screen">
            ...
            <main className="flex-grow pt-24 pb-16 px-6 lg:px-8">
                <div className="max-w-4xl mx-auto bg-white p-8 md:p-12 rounded-2xl shadow-sm border border-gray-100">
                    <h1 className="text-3xl md:text-4xl font-bold text-[#47544b] mb-8 text-center uppercase tracking-wide">Términos y Condiciones</h1>

                    <div className="space-y-8 text-sm md:text-base leading-relaxed text-gray-600">

                        <section>
                            <h2 className="text-xl font-bold text-[#47544b] mb-4 uppercase tracking-wider">Información Relevante</h2>
                            <p className="mb-4">
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-[#47544b] mb-4 uppercase tracking-wider">Licencia</h2>
                            <p>
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-[#47544b] mb-4 uppercase tracking-wider">Uso No Autorizado</h2>
                            <p>
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-[#47544b] mb-4 uppercase tracking-wider">Propiedad</h2>
                            <p>
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-[#47544b] mb-4 uppercase tracking-wider">Política de Reembolso y Garantía</h2>
                            <p>
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-[#47544b] mb-4 uppercase tracking-wider">Comprobación Antifraude</h2>
                            <p>
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-[#47544b] mb-4 uppercase tracking-wider">Privacidad</h2>
                            <p className="mb-4">
