...
import adrianImg from '../assets/CuadradaAdrian.png';
...
const ServiceDetail = ({ slug: propSlug }) => {
    ...
    const dynamicData = getNodeData('servicio-' + slug) || {};
    const localFallback = servicesData[slug] || {};

    const serviceTitle = dynamicData.title || localFallback.title || 'Servicio';
    const serviceDescription = dynamicData.description || localFallback.description || '';
    ...
    if (!localFallback.title && !dynamicData.title) {
        return (
        ...
        <div className="min-h-screen bg-[#D0D0DA] font-sans text-[#233657]">
            ...
            <section className="bg-[#D0D0DA] text-[#233657] py-24 px-4 overflow-hidden relative">
                <div className="max-w-7xl mx-auto flex flex-col items-center text-center relative z-10">
                    <h1 
                        className="text-4xl md:text-6xl font-black mb-8 leading-tight uppercase drop-shadow-sm"
                        dangerouslySetInnerHTML={{ __html: serviceTitle }}
                    />

                    <p 
                        className="text-lg md:text-xl font-medium leading-relaxed max-w-3xl mb-12 opacity-90"
